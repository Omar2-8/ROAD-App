...
import 'package:public_transit_tracking_app/DriverRegistration/reset_taxi_password.dart';
...
class LoginTaxiDriverPage extends StatefulWidget {
  @override
  _LoginTaxiDriverPageState createState() => _LoginTaxiDriverPageState();
}

class _LoginTaxiDriverPageState extends State<LoginTaxiDriverPage> {
                        ...
                        TextSpan(
                          ...
                          recognizer: new TapGestureRecognizer()
                            ..onTap =() => {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => ResetTaxiPassword()
                                  ))},
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if(!emailTextEditingController.text.contains("@")){
                              ...
                              logInAndAuthenticateTaxiDriver(context);
                            }
                          }
                      ),
                    ),
  ...
  void logInAndAuthenticateTaxiDriver(BuildContext context) async {
    print({
      ...
      if (userCredential.user != null ){
        taxiDriversRef.child(userCredential.user.uid).once().then((DataSnapshot snap){
          if(snap.value != null) {
            //Navigator.push(context, MaterialPageRoute(builder: (context) => ));-
            setState(() {
              firebaseUserCurrent.value = userCredential.user;
              driverType.value='t';
            });
