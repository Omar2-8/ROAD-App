...
class ResetBusPassword extends StatefulWidget {
  @override
  _ResetBusPasswordState createState() => _ResetBusPasswordState();
}

class _ResetBusPasswordState extends State<ResetBusPassword> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: IconButton(
        ...
        onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => LoginBusDriverPage()))
      ),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          await FirebaseAuth.instance.sendPasswordResetEmail(email: emailTextEditingController.text).then((value) => {
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>LoginBusDriverPage())),
                          });
                        },
                      ),
                    ),
