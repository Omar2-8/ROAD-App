...
class SettingsUserPage extends StatefulWidget {
  const SettingsUserPage({Key key}) : super(key: key);
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: ListTile(
                      ...
                      trailing:
                          Text('${currentUser.value?.username??''}', style: TextStyle(color: Colors.blue)),
                    ),
                  ),
                ),
            ),
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: ListTile(
                    ...
                    trailing:
                        Text('${currentUser.value?.email??''}', style: TextStyle(color: Colors.blue)),
                  ),
                ),
              ),
            ),
